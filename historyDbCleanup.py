...
dbHistoryTables = ['verbruikWater', 'verbruikElektra', 'temperatuur', 'weerStation', 'barometer', 'upsStatus']
# dbHistoryTables = ['barometer']
...
db.dbHistoryCon.execute("VACUUM FULL")
